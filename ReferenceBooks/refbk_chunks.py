...
# with open(
#     r"C:\Users\Maham Jafri\Documents\Office Tasks\Durbeen\ReferenceBooks\southeast_missouri\Southeast Missouri State University (2005) Rubric examples.md",
#     "r",
#     encoding="utf-8",
# ) as f:
...
# table_pattern = r"\*\*TABLE-[^\*]+\*\*"  # Matches **TABLE-...**
...
# # Save to JSON
# with open("southeast_missouri_chunks.json", "w", encoding="utf-8") as f:
