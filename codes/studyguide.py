...
#         **Main Themes:**
#         [List the 5–6 key themes of the article as bullet points. These are broad, conceptual takeaways.]
...
#         ---
#         **Study Guide: [Insert Article Title]**
#         This study guide is designed to help you review and understand the key concepts presented in the article **"[Insert Article Title]"** by [Insert Author].
#         ---
#         **Quiz (Short Answer)**
...
# Return only the study guide, in clean and structured markdown. Do not add anything outside the format. Replace placeholder tags like [Insert Article Title] and [Insert Author] with actual values from the document.
# """
#         response = self.client.chat.completions.create(
#             model="gpt-4.1",
#             messages=[{"role": "system", "content": prompt}],
...
#         content = self.extract_text(doc_path)
#         prompt = f"""You are an AI skilled in organizing knowledge into a hierarchical structure. Convert the document below into a JSON-formatted mind map.

# Structure it with a main topic (`name`) and nested subtopics (`children`), formatted to work with tree visualizations like `react-d3-tree`.
